...
using System;
namespace Soenneker.PayPal.OpenApiClient.Customer_disputes_v1.V1.Customer.Disputes.Item.SendMessage
{
    /// <summary>
    /// Builds and executes requests for operations under \customer_disputes_v1\v1\customer\disputes\{id}\send-message
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class SendMessageRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PayPal.OpenApiClient.Customer_disputes_v1.V1.Customer.Disputes.Item.SendMessage.SendMessageRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SendMessageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/customer_disputes_v1/v1/customer/disputes/{id}/send-message", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PayPal.OpenApiClient.Customer_disputes_v1.V1.Customer.Disputes.Item.SendMessage.SendMessageRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SendMessageRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/customer_disputes_v1/v1/customer/disputes/{id}/send-message", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PayPal.OpenApiClient.Customer_disputes_v1.V1.Customer.Disputes.Item.SendMessage.SendMessageRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.PayPal.OpenApiClient.Customer_disputes_v1.V1.Customer.Disputes.Item.SendMessage.SendMessageRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.PayPal.OpenApiClient.Customer_disputes_v1.V1.Customer.Disputes.Item.SendMessage.SendMessageRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class SendMessageRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
