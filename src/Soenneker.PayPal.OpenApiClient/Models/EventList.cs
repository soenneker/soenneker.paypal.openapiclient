...
namespace Soenneker.PayPal.OpenApiClient.Models
{
    ...
    public partial class EventList : IAdditionalDataHolder, IParsable
    {
        ...
        /// <summary>The number of items in each range of results. Note that the response might have fewer items than the requested `page_size` value.</summary>
...
#nullable restore
        ...
        public static global::Soenneker.PayPal.OpenApiClient.Models.EventList CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PayPal.OpenApiClient.Models.EventList();
        }
        /// <summary>
