...
namespace Soenneker.PayPal.OpenApiClient.Models
{
    ...
    public partial class Failed_payment_details : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        public global::Soenneker.PayPal.OpenApiClient.Models.Failed_payment_details_reason_code? ReasonCode { get; private set; }
        /// <summary>The date and time, in [Internet date and time format](https://tools.ietf.org/html/rfc3339#section-5.6). Seconds are required while fractional seconds are optional.&lt;blockquote&gt;&lt;strong&gt;Note:&lt;/strong&gt; The regular expression provides guidance but does not reject all invalid dates.&lt;/blockquote&gt;</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PayPal.OpenApiClient.Models.Failed_payment_details"/> and sets the default values.
        /// </summary>
        public Failed_payment_details()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PayPal.OpenApiClient.Models.Failed_payment_details"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PayPal.OpenApiClient.Models.Failed_payment_details CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PayPal.OpenApiClient.Models.Failed_payment_details();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "reason_code", n => { ReasonCode = n.GetEnumValue<global::Soenneker.PayPal.OpenApiClient.Models.Failed_payment_details_reason_code>(); } },
