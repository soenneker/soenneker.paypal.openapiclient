...
namespace Soenneker.PayPal.OpenApiClient.Models
{
    ...
    public partial class GooglePayRequestDecryptedToken : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Authentication Method which is used for the card transaction.</summary>
        public global::Soenneker.PayPal.OpenApiClient.Models.GooglePayDecryptedTokenDataAuthenticationMethod? AuthenticationMethod { get; set; }
...
#nullable restore
        ...
        /// </summary>
        public GooglePayRequestDecryptedToken()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PayPal.OpenApiClient.Models.GooglePayRequestDecryptedToken"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PayPal.OpenApiClient.Models.GooglePayRequestDecryptedToken CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PayPal.OpenApiClient.Models.GooglePayRequestDecryptedToken();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "authentication_method", n => { AuthenticationMethod = n.GetEnumValue<global::Soenneker.PayPal.OpenApiClient.Models.GooglePayDecryptedTokenDataAuthenticationMethod>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.PayPal.OpenApiClient.Models.GooglePayDecryptedTokenDataAuthenticationMethod>("authentication_method", AuthenticationMethod);
