...
namespace Soenneker.PayPal.OpenApiClient.Models
{
    ...
    public partial class Invoice_detail : global::Soenneker.PayPal.OpenApiClient.Models.Detail, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PayPal.OpenApiClient.Models.Invoice_payment_term? PaymentTerm { get; set; }
#nullable restore
#else
        public global::Soenneker.PayPal.OpenApiClient.Models.Invoice_payment_term PaymentTerm { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PayPal.OpenApiClient.Models.Invoice_detail"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Soenneker.PayPal.OpenApiClient.Models.Invoice_detail CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PayPal.OpenApiClient.Models.Invoice_detail();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "payment_term", n => { PaymentTerm = n.GetObjectValue<global::Soenneker.PayPal.OpenApiClient.Models.Invoice_payment_term>(global::Soenneker.PayPal.OpenApiClient.Models.Invoice_payment_term.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.PayPal.OpenApiClient.Models.Invoice_payment_term>("payment_term", PaymentTerm);
        }
    }
}
