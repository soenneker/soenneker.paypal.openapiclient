...
namespace Soenneker.PayPal.OpenApiClient.Models
{
    ...
    public partial class Metadata : global::Soenneker.PayPal.OpenApiClient.Models.Template_metadata, IParsable
    {
...
#nullable restore
        ...
        public global::Soenneker.PayPal.OpenApiClient.Models.Invoice_creation_flow? CreatedByFlow { get; set; }
        /// <summary>The date and time, in [Internet date and time format](https://tools.ietf.org/html/rfc3339#section-5.6). Seconds are required while fractional seconds are optional.&lt;blockquote&gt;&lt;strong&gt;Note:&lt;/strong&gt; The regular expression provides guidance but does not reject all invalid dates.&lt;/blockquote&gt;</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "created_by_flow", n => { CreatedByFlow = n.GetEnumValue<global::Soenneker.PayPal.OpenApiClient.Models.Invoice_creation_flow>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.PayPal.OpenApiClient.Models.Invoice_creation_flow>("created_by_flow", CreatedByFlow);
