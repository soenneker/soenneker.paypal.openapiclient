...
namespace Soenneker.PayPal.OpenApiClient.Models
{
    ...
    public partial class OrderApplicationContext_stored_payment_source : global::Soenneker.PayPal.OpenApiClient.Models.StoredPaymentSource, IParsable
    {
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PayPal.OpenApiClient.Models.OrderApplicationContext_stored_payment_source"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Soenneker.PayPal.OpenApiClient.Models.OrderApplicationContext_stored_payment_source CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PayPal.OpenApiClient.Models.OrderApplicationContext_stored_payment_source();
        }
        /// <summary>
