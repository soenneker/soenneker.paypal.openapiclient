...
namespace Soenneker.PayPal.OpenApiClient.Models
{
    ...
    public partial class PaymentsPaymentV2CaptureStatus : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The status of the captured payment.</summary>
        public global::Soenneker.PayPal.OpenApiClient.Models.PaymentsPaymentV2CaptureStatus_status? Status { get; private set; }
...
#nullable restore
        ...
        /// </summary>
        public PaymentsPaymentV2CaptureStatus()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PayPal.OpenApiClient.Models.PaymentsPaymentV2CaptureStatus"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PayPal.OpenApiClient.Models.PaymentsPaymentV2CaptureStatus CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PayPal.OpenApiClient.Models.PaymentsPaymentV2CaptureStatus();
        }
        /// <summary>
