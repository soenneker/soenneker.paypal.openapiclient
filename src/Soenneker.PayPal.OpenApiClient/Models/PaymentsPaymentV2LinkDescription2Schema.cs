...
namespace Soenneker.PayPal.OpenApiClient.Models
{
    ...
    public partial class PaymentsPaymentV2LinkDescription2Schema : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        public PaymentsPaymentV2LinkDescription2Schema()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PayPal.OpenApiClient.Models.PaymentsPaymentV2LinkDescription2Schema"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PayPal.OpenApiClient.Models.PaymentsPaymentV2LinkDescription2Schema CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PayPal.OpenApiClient.Models.PaymentsPaymentV2LinkDescription2Schema();
        }
        /// <summary>
