...
namespace Soenneker.PayPal.OpenApiClient.Models
{
    ...
    public partial class TemplateDetail : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PayPal.OpenApiClient.Models.TemplateMetadata? Metadata { get; set; }
#nullable restore
#else
        public global::Soenneker.PayPal.OpenApiClient.Models.TemplateMetadata Metadata { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PayPal.OpenApiClient.Models.PaymentTerm? PaymentTerm { get; set; }
#nullable restore
#else
        public global::Soenneker.PayPal.OpenApiClient.Models.PaymentTerm PaymentTerm { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PayPal.OpenApiClient.Models.TemplateDetail"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PayPal.OpenApiClient.Models.TemplateDetail"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PayPal.OpenApiClient.Models.TemplateDetail CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PayPal.OpenApiClient.Models.TemplateDetail();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "metadata", n => { Metadata = n.GetObjectValue<global::Soenneker.PayPal.OpenApiClient.Models.TemplateMetadata>(global::Soenneker.PayPal.OpenApiClient.Models.TemplateMetadata.CreateFromDiscriminatorValue); } },
                { "note", n => { Note = n.GetStringValue(); } },
                { "payment_term", n => { PaymentTerm = n.GetObjectValue<global::Soenneker.PayPal.OpenApiClient.Models.PaymentTerm>(global::Soenneker.PayPal.OpenApiClient.Models.PaymentTerm.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.PayPal.OpenApiClient.Models.TemplateMetadata>("metadata", Metadata);
            writer.WriteStringValue("note", Note);
            writer.WriteObjectValue<global::Soenneker.PayPal.OpenApiClient.Models.PaymentTerm>("payment_term", PaymentTerm);
