...
namespace Soenneker.PayPal.OpenApiClient.Models
{
    ...
    public partial class VerifyWebhookSignatureResponse : IAdditionalDataHolder, IParsable
    {
        ...
        public static global::Soenneker.PayPal.OpenApiClient.Models.VerifyWebhookSignatureResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PayPal.OpenApiClient.Models.VerifyWebhookSignatureResponse();
        }
        /// <summary>
