...
namespace Soenneker.PayPal.OpenApiClient.Models
{
    ...
    public partial class WalletBase : IAdditionalDataHolder, IParsable
    {
        ...
        public global::Soenneker.PayPal.OpenApiClient.Models.WalletBase_customer_type? CustomerType { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.PayPal.OpenApiClient.Models.WalletBase_usage_pattern? UsagePattern { get; set; }
        /// <summary>The usage type associated with a digital wallet payment token.</summary>
        public global::Soenneker.PayPal.OpenApiClient.Models.WalletBase_usage_type? UsageType { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PayPal.OpenApiClient.Models.WalletBase"/> and sets the default values.
        /// </summary>
        public WalletBase()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PayPal.OpenApiClient.Models.WalletBase"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PayPal.OpenApiClient.Models.WalletBase CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PayPal.OpenApiClient.Models.WalletBase();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "customer_type", n => { CustomerType = n.GetEnumValue<global::Soenneker.PayPal.OpenApiClient.Models.WalletBase_customer_type>(); } },
                ...
                { "usage_pattern", n => { UsagePattern = n.GetEnumValue<global::Soenneker.PayPal.OpenApiClient.Models.WalletBase_usage_pattern>(); } },
                { "usage_type", n => { UsageType = n.GetEnumValue<global::Soenneker.PayPal.OpenApiClient.Models.WalletBase_usage_type>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.PayPal.OpenApiClient.Models.WalletBase_customer_type>("customer_type", CustomerType);
            ...
            writer.WriteEnumValue<global::Soenneker.PayPal.OpenApiClient.Models.WalletBase_usage_pattern>("usage_pattern", UsagePattern);
            writer.WriteEnumValue<global::Soenneker.PayPal.OpenApiClient.Models.WalletBase_usage_type>("usage_type", UsageType);
